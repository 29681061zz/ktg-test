...
class ProcessAPI(BaseApi):
    ...
    def search_processes(self,search_data:Dict[str, Any],page_num: int = 1,page_size: int = 10) -> Dict[str, Any]:
        """搜索工序"""
    ...
    def edit_process(self,edit_data: Dict[str, Any]) -> Dict[str, Any]:
        """修改工序信息"""
        endpoint = "/mes/pro/process"
        search_response = self.search_processes(edit_data)
        process_id = search_response['data'][0]['processId']
        edit_data["processId"] =process_id
    ...
    def delete_process(self, delete_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        endpoint = "/mes/pro/process"
        # 通过编码搜索获取工序ID
        search_response = self.search_processes(delete_data)
        process_id = search_response['data'][0]['processId']
        # 发送删除请求
