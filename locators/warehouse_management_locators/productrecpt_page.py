...
class ProductRecptLocators:
    ...
    # 表单元素remark
    PRODUCRECPT_CODE_INPUT = (By.XPATH, "(//input[@placeholder='请输入入库单编号'])[2]")
    PRODUCRECPT_NAME_INPUT = (By.XPATH, "(//input[@placeholder='请输入入库单名称'])[2]")
    PRODUCRECPT_POCODE = (By.XPATH, "(//input[@placeholder='请输入采购订单号'])")
    PRODUCRECPT_DATE_INPUT = (By.XPATH, "(//input[@placeholder='请选择入库日期'])")

    WORKORDERCODE_SELECT = (By.XPATH, "//input[@placeholder='请选择生产工单']/following-sibling::div/button[@type='button']")
    WORKORDERCODE_STATUS = (By.XPATH, "//li//span[text()='草稿']")
    WORKORDERCODE_CODE = (By.XPATH, "//input[@placeholder='请输入工单编码']")
    WORKORDERCODE_SEARCH = (By.XPATH, "(//button[.//span[text()='搜索']])[2]")
    SELECT_WORKORDERCODE_BUTTON = (By.XPATH, "//td[contains(@class, 'is-center')]//label[@role='radio']")
    SELECT_WORKORDERCODE_CONFIRM = (By.XPATH, "//button//span[text()='确 定']")
